import svgPaths from "./svg-abnzna0rid";
...
function Frame20() {
  return (
    <div className="absolute h-[130px] left-0 top-[120px] w-[578px]">
      <div className="absolute flex flex-col font-['Noto_Sans:Display_Regular',_sans-serif] font-normal justify-center leading-[0] left-0 opacity-[0.85] text-[0px] text-neutral-50 text-nowrap top-[-23px] translate-y-[-50%] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 100, 'wdth' 100" }}>
...
function Frame21() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center justify-center left-0 top-[140px]">
...
function Frame22() {
  return (
    <div className="absolute h-[177px] left-0 top-[172px] w-[295px]">
      <Frame19 />
      <Frame21 />
    </div>
  );
...
function Frame23() {
  return (
    <div className="absolute h-[437px] left-[671px] top-[204px] w-[578px]">
      <Frame20 />
      <Frame22 />
    </div>
  );
...
function Frame() {
  return (
    <div className="absolute h-[777px] left-0 overflow-clip top-0 w-[1920px]">
      ...
      <Frame23 />
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*1)+(var(--transform-inner-height)*0)))] items-center justify-center left-[935px] top-[659px] w-[calc(1px*((var(--transform-inner-height)*1)+(var(--transform-inner-width)*0)))]" style={{ "--transform-inner-width": "50", "--transform-inner-height": "50" } as React.CSSProperties}>
...
function Group() {
  return (
    <div className="absolute left-0 size-[7px] top-[249px]">
...
function Frame11() {
  return (
    <div className="absolute h-[315px] left-[407px] top-[235px] w-[1106px]">
      <Frame2 />
      <Frame10 />
      <Frame4 />
      <Frame3 />
...
function Component7() {
  return (
    <div className="absolute bg-white h-[550px] left-[-1px] overflow-auto top-[2694px] w-[1920px]" data-name="푸터 바탕">
      <Frame11 />
    </div>
  );
}
...
function Bom() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] items-center justify-center left-0 top-0" data-name="BOM 메뉴버튼">
...
function Frame16() {
  return (
    <div className="absolute h-[17px] left-0 top-[2.5px] w-[58px]">
      <Bom />
    </div>
  );
}
...
function Scm() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] h-[22px] items-center justify-center left-0 p-[10px] rounded-[100px] top-0" data-name="SCM">
      <div className="flex flex-col font-['Microsoft_Sans_Serif:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[15px] text-nowrap text-white">
...
function Mes() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] h-[22px] items-center justify-center left-[90px] p-[10px] rounded-[100px] top-0" data-name="MES">
      <div className="flex flex-col font-['Microsoft_Sans_Serif:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[15px] text-nowrap text-white">
...
function Component8() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] h-[22px] items-center justify-center left-[166px] p-[10px] rounded-[100px] top-0" data-name="산업업">
      <div className="flex flex-col font-['Microsoft_Sans_Serif:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[15px] text-nowrap text-white">
...
function Component9() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] h-[22px] items-center justify-center left-[228px] p-[10px] rounded-[100px] top-0" data-name="미션">
...
function Component10() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] h-[22px] items-center justify-center left-[314px] p-[10px] rounded-[100px] top-0" data-name="미션">
      <div className="flex flex-col font-['Microsoft_Sans_Serif:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[15px] text-nowrap text-white">
...
function Frame17() {
  return (
    <div className="absolute h-[22px] left-[110px] top-0 w-[376px]">
      <Scm />
      <Mes />
      <Component8 />
      <Component9 />
...
function Frame18() {
  return (
    <div className="absolute h-[22px] left-[768px] top-[54px] w-[486px]">
      <Frame16 />
      <Frame17 />
    </div>
  );
